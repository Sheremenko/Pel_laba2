def perevozchic(text, encoding='utf-8', errors='surrogatepass'):
    bits = bin(int.from_bytes(text.encode(encoding, errors), 'big'))[2:]
    return bits.zfill(8 * ((len(bits) + 7) // 8))
def perevozchic2(bits, encoding='utf-8', errors='surrogatepass'):
    n = int(bits, 2)
...
print("Исходное слово: ", perevozchic2(res))
